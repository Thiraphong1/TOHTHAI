...
export const createReservation = async (token, reservationData) => {
  ...
  return await axios.post('https://tohthaibackend.vercel.app/api/reservation', reservationData, {
...
export const getCurrentTableStatus = async () => {
  ...
  return await axios.get('https://tohthaibackend.vercel.app/api/tables/current-status');
};
